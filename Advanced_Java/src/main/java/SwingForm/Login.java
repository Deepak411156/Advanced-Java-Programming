        ...
        btnLogin.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (status == true) {
                    ...
                    JOptionPane.showMessageDialog(Login.this, message, "Success", JOptionPane.INFORMATION_MESSAGE);
                    AdminForm admin = new AdminForm();

                    admin.setVisible(true);
                    Login.this.dispose(); // login  को object नबनाउनु  direct Login.this.dispose(); गर्नु  
